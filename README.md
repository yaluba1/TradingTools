...
- **`ibkr_marketdata`**: Fetch historical OHLCV bar data with customizable intervals, durations, regular trading hours filters, and pricing sources (Last, Bid, Ask, Midpoint, Inventory).
